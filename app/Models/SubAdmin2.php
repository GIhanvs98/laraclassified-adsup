...
class SubAdmin2 extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable = ['country_code', 'subadmin1_code', 'code', 'name', 'active', 'order'];
    ...
    */
    ...
    {
        return $this->hasOne(City::class, 'subadmin2_code', 'code');
    }

    public function cities(): HasMany
    {
        return $this->hasMany(City::class, 'subadmin2_code', 'code');
    }
