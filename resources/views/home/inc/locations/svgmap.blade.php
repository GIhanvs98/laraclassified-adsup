...
@if ($mapCanBeShown)
	...
	<div class="col-12 text-center p-4">
		<div id="countryMap" class="page-sidebar col-thin-left no-padding" style="margin: auto;width: 100%;display: contents;">&nbsp;</div>
	</div>
@endif
				...
				$('#countryMap').twism("create",
				{
					...
					click: function(region) {
						...
						@if (config('settings.seo.multi_countries_urls'))
							searchPage = searchPage + queryStringSeparator + 'country={{ config('country.code') }}&l=' + encodedLocation;
						@else
							searchPage = searchPage + queryStringSeparator + 'l=' + encodedLocation;
						@endif
