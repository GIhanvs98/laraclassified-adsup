			...
			<ul class="navbar-nav justify-content-end">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-end user-dd">
						...
						<a class="dropdown-item flex" href="{{ url('account') }}">
							<i data-feather="user" class="feather-sm text-info me-1 ms-1"></i> {{ trans('admin.my_account') }}
						</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item flex" href="{{ admin_url('account') }}">
							<i class="fas fa-cog feather-sm text-info me-1 ms-1"></i> Account Settings
						</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item flex" href="{{ admin_url('logout') }}">
