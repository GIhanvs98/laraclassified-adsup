...
<div class="row page-titles">
    <div class="col-md-6 col-12 align-self-center">
        <h2 class="mb-0">
            <span class="text-capitalize">Cities</span>
    ...
    <div class="col-md-6 col-12 align-self-center d-none d-md-flex justify-content-end">
        <ol class="breadcrumb mb-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item active d-flex align-items-center">Cities</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="controlls" style="display: flex; margin-bottom: 20px;">
            ...
            <a href="{{ route('admin.locations.cities.new') }}" style="margin-right: 5px;">
