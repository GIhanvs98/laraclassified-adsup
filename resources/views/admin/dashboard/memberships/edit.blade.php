    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h2 class="mb-0">
				...
				<small id="tableInfo">Edit membership</small>
            </h2>
        </div>
        <div class="col-md-7 col-12 align-self-center d-none d-md-flex justify-content-end">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
				...
				<li class="breadcrumb-item active d-flex align-items-center">Edit</li>
            </ol>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <livewire:admin-membership-edit :membership="$membership" :currencyCodes="$currencyCodes">
