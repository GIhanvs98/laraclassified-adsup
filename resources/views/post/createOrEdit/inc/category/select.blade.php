	...
	@if (!empty($category))
		...
		<script>
			$(document).ready(function(){
				$(".sub_category_group_bt.prev_container").attr("sub_category_group_id", sessionStorage.getItem("sub_category_group_id"));
			});
		</script>

		<p>
			<a href="#" class="btn btn-sm cat-link btn-success sub_category_group_bt prev_container" data-bs-toggle="modal" sub_category_group_id="">
