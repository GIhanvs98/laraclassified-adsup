<div>
    ...
    <h3 style="margin: 0 0 15px;">Where is your item or service located?</h3>
    ...
    <div class="row" x-data="{ open: false }" style="margin-top: 25px;">
            ...
            <div class="col">
                <ul class="nav flex-column" style="border-bottom: 1px solid #d4ded9;">
                    ...
                    <li style="padding: 0px;">
                        <h5 class="modal-title" style="padding: 0.5rem 1rem 0.5rem 0rem !important;color: #2f3432;margin-bottom: 8px;font-size: 1rem !important;line-height: 1.33333333 !important;">Select a District</h5>
                    </li>
                ...
                <ul wire:loading.flex class="nav flex-column">
                    ...
                    @if(isset($cities) && $cities->count() > 0)
                        <ul class="nav flex-column" wire:loading.remove style="border-bottom: 1px solid #d4ded9;">
                            ...
                            <li style="padding: 0px;">
                                <h5 class="modal-title" style="padding: 0.5rem 1rem 0.5rem 0rem !important;color: #2f3432;margin-bottom: 8px;font-size: 1rem !important;line-height: 1.33333333 !important;">Select a local area within @isset($selectedDistrict) {{ $selectedDistrict->name }} @endisset</h5>
                            </li>
