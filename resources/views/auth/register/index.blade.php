					...
					<div class="inner-box" style="background-color: white;">
						...
						<div class="row{{ $mtAuth }}">
							<div class="col-12">
								    ...
								    <fieldset>
								        ...
								        <div class="row mb-3 required">
								            ...
								            <div class="col-md-9 col-lg-6">
								                ...
								                <input id="passwordConfirmation" name="password_confirmation" type="password" class="form-control{{ $passwordError }}" placeholder="{{ t('Password Confirmation') }}" autocomplete="off">
								                <div class="form-text text-muted">
                        		...
                        		<div class="d-flex justify-content-center or">Or continue with</div>

								<div class="d-flex justify-content-center mb-2">
									@includeFirst([config('larapen.core.customizedViewPath') . 'auth.login.inc.social-round', 'auth.login.inc.social-round'])
								</div>
...
@section('after_scripts')
	...
	<script type="text/javascript" src="{{ asset('assets/plugins/hideShowPassword/hideShowPassword.min.js') }}"></script>
	<script>
		/*
