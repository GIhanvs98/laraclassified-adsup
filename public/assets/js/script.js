...
$(document).ready(function () {
  ...
  let tooltipHoverTriggerList = [].slice.call(
    document.querySelectorAll('[data-bs-toggle="tooltipHover"]')
  );
  let tooltipHoverList = tooltipHoverTriggerList.map(function (
    tooltipTriggerEl
  ) {
    return new bootstrap.Tooltip(tooltipTriggerEl, {
      trigger: "hover",
  ...
  $("#checkAll").click(function () {
    $(".add-img-selector input:checkbox")
      .not(this)
...
function setCountryPhoneCode(countryCode, countries) {
  if (typeof countryCode == "undefined" || typeof countries == "undefined")
    return false;
